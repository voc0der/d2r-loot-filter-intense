...
[*][b]Remove Superior Prefix[/b] — removes the shared Superior/Sup word while leaving base names visible; combined with Hide Unpopular Bases, Superior Heavy Gloves becomes only the selected dot
